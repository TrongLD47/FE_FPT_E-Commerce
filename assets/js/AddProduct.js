...
$(document).ready(function () {
  ...
  $("#add").click(function () {
    ...
    $("#dynamic_field").append(
      '<tr id="row' +
        i +
        '"><td><input type="text" name="InputSize" id="InputSize" class="form-control"></td><td><input type="text" name="InputColor" id="InputColor" class="form-control"></td> <td> <input type="number" name="Inputqty" id="Inputqty" min="1" class="form-control"> </td><td><button type="button" name="remove" id="' +
        i +
